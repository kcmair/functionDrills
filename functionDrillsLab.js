...
function add(para1, para2){
  let num1 = Number(para1)
  let num2 = Number(para2)
  let total = num1 + num2
  return total
// console.log(total)
};
...
// console.log(exclaimThree('lowertoupper'));
...
//CODE HERE
function theEliminator(tributes, dead) {
...
let capsLock = (toUpper) => toUpper.toUpperCase();
...
const emailCheck = (checkString) => {
  let newString = String(checkString)
  let trimmedString = newString.trim()
  let verified = trimmedString.includes(`@`)
  if (verified){
...
// console.log(emailCheck(`keithhotmail.com`));
...
function chocolateFrogs (lucre){
  let numFrogs = Math.floor(lucre/3)
  return numFrogs
};
// console.log(chocolateFrogs(1));
